    ...
    <Popover>
      <PopoverTrigger asChild>
        <Button
          variant="outline"
          className={cn(
            "w-full justify-between min-h-8 h-auto font-normal bg-white border-blue-200 text-blue-900 shadow-sm px-2 py-1",
            className
          )}
        >
            ...
            {selected.map((val) => {
              ...
              return (
                <Badge
                  key={val}
                  variant="secondary"
                  className="bg-blue-50 text-blue-700 text-[10px] px-1 h-5 flex items-center gap-1 border-blue-100"
                >
                  {option?.label || val}
                  <X
